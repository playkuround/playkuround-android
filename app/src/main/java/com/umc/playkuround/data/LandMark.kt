    ...
    fun getDescription() : String {
        return when(this.id) {
            1 -> "대형강의실이 많으며 1층에는 건국유업 카페 브랜드인 레스티오가 있어요. " +
                    "상허교양대학 행정실이 있어 교양 과목 추가신청과 성적 이의제기를 할 수 있어요. " +
            ...
            6 -> "1,4,5층은 자료실 3,6층은 열람실로 사용돼요." +
                    ...
                    "상허문에서 상허기념도서관에 이르는 도로 양편에 세계의 언어와 문자를 새긴 비석이 세워져있어요."
            7 -> "지하 1층에는 카페 레스티오가 있으며 예술영화관인 ku시네마가 자리 잡고 있어요." +
                    "3층에는 테라스 형식으로 된 휴게소가 있으며 주로 흡연실로 사용한다 해요. (카더라)" +
                    "건국대학교 학생이라면 평일 7,000원 주말 9,000원에 영화를 볼 수 있어요."
            8 -> "카페 레스티오가 있으며 예술영화관인 ku시네마가 자리 잡고 있어요." +
                    "3층에는 테라스 형식으로 된 휴게소가 있으며 주로 흡연실로 사용한다 해요. (카더라)" +
                    "건국대학교 학생이라면 7,000원에 영화를 볼 수 있어요."
            9 -> "과거 도서관이였어요." +
            ...
            10 -> "건국대 로스쿨이 존재해요." +
                    ...
                    "1층에는 법학전문도서관이 있어요."
            11 -> "상허박물관에는 역사유물뿐만 아니라 우리 대학의 설립자인 상허 유석창의 유품과 학교의 역사 자료를 볼 수 있어요."
            12 -> "학생회관 학생복지처에서 발급받을 수 없는 수입인지의 경우 여기에서 발급받을 수 있어요."
            13 -> "사범대학학생들이 많이 가며 타 학과의 학생인 경우에도 교직이수를 할 때 교과교육론이나 교재연구론을 듣기 위해 가요."
            14 -> "1층에는 카페나무라는 카페가 있으며 3층은 학부강의실과 K큐브(오픈형 자습공간)이 있어요. 특히 스터디룸이 있어 팀플하기 좋으며 위인전을 통해 예약을 할 수 있어요."
            15 -> "2021년에 신식으로 1층에 K-HUB(오픈형 자습공간)가 있다. 이외에도 편의점, 인쇄소가 있어요." +
                    "상허연구관이 생기기 전에는 “사회과학관”이라는 이름이였으며 정치대-행정학과, 정외과, 부동산학과가 있었었어요." +
                    "웹툰 치즈인더트랩의 배경이에요."
            ...
            22 -> "엘레베이터가 없어요." +
                    "1층에 서점이 위치해 있어요." +
                    "공대 과사무실들이 위치해 있어요."
            23 -> "168호에서 소프트웨어를 무료로 대여가능해요.이때 학생 신분증은 필수에요!"
            ...
            27 -> "신산업융학과 교수님들의 연구실이 있어요." +
                    ...
                    "구의역에서 가는게 빨라요." +
                    "예전에 건대부중 건물로 사용되었어요."
            28 -> "리빙 디자인 학과학생들이 실습을 위해 사용해요." +
                    "리빙 디자인학과생들 말고는 잘 모르는 희귀의 건물이에요."
            29 -> ""
            30 -> "기숙사에서는 취사가 안돼요" +
                    "헬스장이 오픈 했어요"
            31 -> "축제 때 보트를 띄우고 놀아요." +
